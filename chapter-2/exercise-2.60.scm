; Exercise 2.60.  We specified that a set would be represented as a list with
; no duplicates. Now suppose we allow duplicates. For instance, the set
; {1,2,3} could be represented as the list (2 3 2 1 3 2 2). Design procedures
