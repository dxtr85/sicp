...
; balanced tree containing the first n elements of the list. The result returned
; by partial-tree is a pair (formed with cons) whose car is the constructed tree
...
; partial tree chops original ordered list into two equal sublists and an element
; in the middle and then creates a tree whose main entry is that middle element, and
; it's left tree and right tree are calls to partial-tree with remaining sublists
; passed as arguments accordingly.
