...
;; was not possible to use the primitives of the language directly because
...
;; definitions of type-tag, contents, and attach-tag from section 2.4.2 so that
;; our generic system takes advantage of Scheme's internal type system.
;; That is to say, the system should work as before except that ordinary
;; numbers should be represented simply as Scheme numbers rather than as
