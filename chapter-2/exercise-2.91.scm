...
; The result is the first term of the quotient. Next, multiply the result by the
; divisor, subtract that from the dividend, and produce the rest of the answer
; by recursively dividing the difference by the divisor. Stop when the order of
; the divisor exceeds the order of the dividend and declare the dividend to be
; the remainder. Also, if the dividend ever becomes zero, return zero as both
